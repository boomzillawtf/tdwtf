...
RUN cd node_modules/nodebb-plugin-composer-default && sed -i static/lib/composer/autocomplete.js -e 's/\r//' && curl -sSL https://patch-diff.githubusercontent.com/raw/NodeBB/nodebb-plugin-composer-default/pull/79.diff | patch -p1
